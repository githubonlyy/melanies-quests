...
// dress) and the head with its face (drawn over the dress, under the bangs).
//
...
function Eye({ cx, cy, iris }) {
  return (
    <g>
      ...
      {/* thick upper lid = lashes */}
      <path d={`M ${cx - 11} ${cy - 5} Q ${cx} ${cy - 22} ${cx + 11} ${cy - 5}`} stroke="#3b2b3a" strokeWidth="3" fill="none" strokeLinecap="round" />
    </g>
  )
}
...
export function Head({ skin, eyes = '#4f7fe0' }) {
  ...
  return (
    <g>
      ...
      />
      <ellipse cx="63" cy="118" rx="10" ry="6" fill="#ff8da1" opacity="0.5" />
      <ellipse cx="137" cy="118" rx="10" ry="6" fill="#ff8da1" opacity="0.5" />
