...
//
// Three steps here are easy to get wrong and were all wrong once:
//
 ...
 * artwork. Such a side keeps the old conservative `safe` cap.
 *
...
export function processPage(image, opts = {}) {
  ...
  // over her painting. The plain blur has no such failure: the desk divides by
