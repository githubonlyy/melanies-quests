...
export function pagesFromGlob(globResult, { onSkip } = {}) {
  ...
  // unlike a collator, which is only ever used for what Melanie reads.
  ...
  // Display order: Hebrew for the names she reads, then the id, so that two
...
// holding every page she ever opened. Thumbs are small and all on screen at
...
const MODE_KEY = 'melanies-quests-page-modes'
