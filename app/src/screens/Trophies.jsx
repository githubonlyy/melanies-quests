  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-(--t-panel) p-4 rounded-2xl border-4 border-(--t-panel-border) backdrop-blur-sm">
        <h2 className="text-2xl md:text-3xl font-black text-white drop-shadow-md">הגביעים שלי 🏆</h2>
        <div className="px-3 py-1.5 bg-yellow-400 text-yellow-900 rounded-xl border-b-4 border-yellow-600 font-black text-sm tabular-nums" dir="ltr">
        ...
        {TROPHIES.map((t) => {
          ...
          return (
            ...
            >
              ...
              >
                <Icon className={earnedTs ? 'text-yellow-900 w-8 h-8' : 'text-(--t-text-soft) opacity-70 w-8 h-8'} />
                {!earnedTs && (
